        ...
        <el-main>
          <el-container >
            ...
            <el-main v-if="activeName2=='source'">
              <el-input style="position: relative;z-index:5;" :rows="13" type="textarea" v-model="JSON.stringify(tableSchema)"
                :readonly="true"></el-input>
              <el-input style="position: relative;z-index:5;" :rows="13" type="textarea" v-model="JSON.stringify(newForm)" :readonly="true"></el-input>
            </el-main>
                  ...
                  <table class="formDesigner" id="formDesignerComponents" cellspacing="0" cellpadding="0">
                    <tr v-for="(field,index) in tableSchema">
                      <td style="display:flex;align-items: center;">
                        ...
                        <img src="../../../static/images/sc1.png" alt="删除"  @click="deleteField(field,index)" style="position:absolute;right: 20px;">
      ...
      mousemenu: function(divObj, binding) {
        ...
        divObj.onmousedown = function(_e) {
          ...
          if (target.nodeName.toLowerCase() == "td") {
            ...
            menu1.style.top =
              document.documentElement.scrollTop + _e.clientY -95 + "px";
            if (divObj) {
              if (_e.button == 2) {
                // button == 2 代表右击
    ...
    methods: {
      ...
      selectTd(e) {
        if (e.button == 0 && !this.flagInput) {
          ...
          console.log(this.dragArea.style.width,"this.dragArea.style.width")
          console.log(this.dragArea.style.height,"this.dragArea.style.height")
        ...
        console.log(e.target.getAttribute("data-tr"),"data-tr");
        console.log(e.target.getAttribute("data-td"),"data-td");
        }
      },
      selectTdConfirm(e) {
        this.flagDrag = false;
